...
public class Task1_4 {
  ...
  // 定数（アカウント情報）
  // 1 登録されている名前（USER_NAME）とパスワード（USER_PASSWORD）を定数で定義してください。
